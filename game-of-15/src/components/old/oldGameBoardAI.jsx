...
export default function GameBoardAI({ playerChoice, onGameEnd }) {
  ...
  const handleCellClick = (row, col) => {
    ...
    if (selectedNumber !== null) {
      // If a number is selected, place it in the cell if valid
      if (cellValue === null || cellValue === selectedNumber) {
        ...
        setError("You can only replace your number!"); // Error for invalid placement
